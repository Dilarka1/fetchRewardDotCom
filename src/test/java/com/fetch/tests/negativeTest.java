...
public class negativeTest {
        ...
        Logger logger = LoggerFactory.getLogger(com.fetch.tests.positiveTest.class);
        ...
        @Test(description = "Negative test. Verify page title")
        public void test1() {
        ...
        @Test(description = "Negative test. Finding fake gold bar")
        public void test2() throws InterruptedException {
            ...
            for (int i = 0; i < coins.size(); i++) {
                ...
                if (resultButton.getText().contains(">")) {
                    logger.info("FAKE GOLD BAR is not: {}", num2);
                    ...
                    logger.info("FAKE GOLD BAR is not:" + num1);
